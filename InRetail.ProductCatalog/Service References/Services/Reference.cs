...
// Original file name:
// Generation date: 12/7/2009 2:35:37 PM
namespace InRetail.ProductCatalog.Services
{
    ...
    public partial class ProductCatalogContainer : global::System.Data.Services.Client.DataServiceContext
    {
        ...
        {
            if (typeName.StartsWith("ProductCatalogModel", global::System.StringComparison.Ordinal))
            {
                return this.GetType().Assembly.GetType(string.Concat("InRetail.ProductCatalog.Services", typeName.Substring(19)), true);
            }
            return null;
        }
        /// <summary>
        ...
        {
            if (clientType.Namespace.Equals("InRetail.ProductCatalog.Services", global::System.StringComparison.Ordinal))
            {
                return string.Concat("ProductCatalogModel.", clientType.Name);
            }
            return null;
        }
        /// <summary>
